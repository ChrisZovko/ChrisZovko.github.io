...
header:
  image: assets/img/Great final device image.heic
  teaser:  assets/img/Great final device image.heic
gallery:
  - url: assets/img/Best Testing Image.HEIC
    image_path: assets/img/Best Testing Image.HEIC
